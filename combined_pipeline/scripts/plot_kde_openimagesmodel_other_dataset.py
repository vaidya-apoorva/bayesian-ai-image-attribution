...
def plot_gap_values_kde():
    ...
    # Directory containing SReC D(l) JSON files
    json_dir = "/mnt/ssd-data/vaidya/combined_pipeline/results/OTHER_DATASET/SREC/"
    output_dir = "/mnt/ssd-data/vaidya/combined_pipeline/results/KDE/OTHERS"
    output_file = os.path.join(output_dir, "openimages_other_dataset_srec_gap_values_kde.png")
    ...
    plt.title("KDE of SReC D(l) Gap Values (Other Datasets)", fontsize=16)
...
#     json_dir = "/mnt/ssd-data/vaidya/combined_pipeline/results/OTHER_DATASET/RIGID/OPENIMAGES_MODEL"
#     output_dir = "/mnt/ssd-data/vaidya/combined_pipeline/results/KDE/OTHERS"
#     output_file = os.path.join(output_dir, "openimages_other_dataset_rigid_similarity_values_kde.png")
#     os.makedirs(output_dir, exist_ok=True)
#
#     # Get all json files in the directory
#     json_files = [f for f in os.listdir(json_dir) if f.endswith(".json")]
...
if __name__ == "__main__":
    print("Creating KDE plots for GAP_VALUES")
    plot_gap_values_kde()
