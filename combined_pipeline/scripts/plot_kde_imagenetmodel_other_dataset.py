...
def plot_gap_values_kde():
    ...
    output_file = os.path.join(output_dir, "imagenetmodel_other_dataset_srec_gap_values_kde.png")
...
def plot_similarity_values_kde():
    ...
    json_dir = "/mnt/ssd-data/vaidya/combined_pipeline/results/OTHER_DATASET/RIGID"
    output_dir = "/mnt/ssd-data/vaidya/combined_pipeline/results/KDE/OTHERS"
    output_file = os.path.join(output_dir, "imagenetmodel_other_dataset_rigid_similarity_values_kde.png")
    os.makedirs(output_dir, exist_ok=True)
